...
<html lang="en">
  <head>
    ...
    <title>Home Page- EVS Admin</title>
    <meta charset="utf-8">
  ...
  ?>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="HomePageAdmin.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="row">
          <div class="col-md-3">
              <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
                <div class="info">
                  <h4><a href="OfficialPosition.php" style="text-decoration:none;">Official Position</a></h4>
                  <?php
        ...
        <div class="col-md-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4><a href="RegisterCandidate.php" style="text-decoration:none;">Registered Candidates</a></h4>
              <?php
        ...
        <div class="col-md-3">
            <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
              <div class="info">
                <h4><a href="RegisteredVoters.php" style="text-decoration:none;">Registered Voters</a></h4>
                <?php
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4><a href="Voters.php" style="text-decoration:none;">Voters</a></h4>
              <?php
        ...
        <div class="col-md-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4><a href="NonVoters.php" style="text-decoration:none;">Non-Voters</a></h4>
              <?php
