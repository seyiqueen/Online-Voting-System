...
<html lang="en">
  <head>
    ...
    <title>Official Position- EVS User</title>
    <meta charset="utf-8">
  ...
  ?>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
            ...
            <li><a class="app-menu__item active" href="OfficialPositionUser.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Official Position</span></a></li>
