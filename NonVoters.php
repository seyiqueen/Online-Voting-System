...
<html lang="en">
  <head>
    ...
    <title>Non Voters- EVS Admin</title>
    <meta charset="utf-8">
  ...
  <?php
    ...
    $sql = "select registrationID,matricno,surname,othername,email from register where votestatus = 'not-voted' ";
    $result = mysqli_query($conn,$sql);

  ?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="NonVoters.php"><img src="Images/voteIconpng.png" width="80" height="80" style="float:left"><p style="float:left">EVS</p></a>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Non Voters</h3>
