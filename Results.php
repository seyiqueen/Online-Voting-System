...
<html lang="en">
 ...
 <?php 
  ...
  <?php
      ...
      ?>
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="login.php"><img src="Images/voteIconpng.png" width="80" height="80" style="float:left"><p style="float:left">EVS</p></a>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li ><a class="app-menu__item" href="President.php" ><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Registered Candidates</span></a></li>
        ...
        <li><a class="app-menu__item active" href="Results.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Results</span></span></a></li>
      </ul>
    </aside>
