...
<body class="app sidebar-mini rtl">
  ...
  $sql = "select registrationID,matricno,surname,othername,email from register where votestatus = 'voted' ";
  $result = mysqli_query($conn, $sql);

  ?>

  <!-- Navbar-->
  <header class="app-header"><a class="app-header__logo" href="Voters.php"><img src="Images/voteIconpng.png" width="80" height="80" style="float:left">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="Results.phpp"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Results</span></span></a></li>
